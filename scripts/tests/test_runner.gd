...
func _run_all() -> void:
	var test_scripts: Array[String] = [
		...
		"res://scripts/tests/test_warden_skills.gd",
		"res://scripts/tests/test_audio_manager.gd",
		"res://scripts/tests/test_rift_spawn.gd",
		"res://scripts/tests/test_battle_undo.gd",
		...
		"res://scripts/tests/test_run_expedition_catalog.gd",
		"res://scripts/tests/test_run_map_pool_auditor.gd",
